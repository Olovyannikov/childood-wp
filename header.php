...
<html lang="ru">
	<head>
		...
		<title><?php bloginfo('name'); echo " | "; bloginfo('description');?></title> <!-- Тайтл состоит из Настроек сайта -->
        ...
        <?php 
            wp_head();
        ?> <!-- Функция подключения динамических файлов в head -->
    </head>
    <body class="no-svg">
        <header>
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-11 col-sm-12 col-md-12 col-lg-3">
                        <div class="header__logo">
                            <?php the_custom_logo(  ); ?> <!-- Функция кастомного лого(меняется из админки) -->
                        </div>
                    </div>
                    <div class="col-md-12 col-lg-9 offset-lg-0 col-xl-7 offset-xl-2 ">
                        <div class="header__contacts">
                            <div class="header__contacts-item"> <!-- Ниже функция, которая подставляет путь до темы -->
