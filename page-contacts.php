        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="contacts__map">
                    <?php
                    echo do_shortcode(' [yamap center="55.7473,37.6247" height="100%" controls="" zoom="16" type="yandex#map" mobiledrag="0"][/yamap] ');
                    ?>
                </div>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="contacts__feed">
                    <?php echo do_shortcode(' [contact-form-7 id="126" title="Форма отзывов"] '); ?>
